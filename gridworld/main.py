...
agents = [("Q-Learning", Qlearning.Qlearning)]
...
class GUI(Tk):
    def __init__(self, w = gridworld.DEFAULT_W, h = gridworld.DEFAULT_H,
        ...
        Tk.__init__(self)
        # The current agent
        self.agent = Qlearning.Qlearning()
        ...
        submenu.add_command(label="show Q")
        ...
        self.info_panel.grid(row=1, column=0)  # 放在下面
